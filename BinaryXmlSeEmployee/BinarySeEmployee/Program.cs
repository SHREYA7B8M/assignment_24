...
namespace BinaryXmlSeEmployee
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"C:\Users\KIIT\Desktop\Git Exercise\Day_21\assignment_24\EmployeeAssignment_24\employee.bin", FileMode.Create))
            {
            ...
            using (FileStream fs = new FileStream(@"C:\Users\KIIT\Desktop\Git Exercise\Day_21\assignment_24\EmployeeAssignment_24\employee.bin", FileMode.Open))
            {
            ...
            using (TextWriter write=new StreamWriter(@"C:\Users\KIIT\Desktop\Git Exercise\Day_21\assignment_24\EmployeeAssignment_24\employee.xml"))
            {
           ...
           // Employee deserializedXmlEmployee;
            using (TextReader reader = new StreamReader(@"C:\Users\KIIT\Desktop\Git Exercise\Day_21\assignment_24\EmployeeAssignment_24\employee.xml"))
            {
